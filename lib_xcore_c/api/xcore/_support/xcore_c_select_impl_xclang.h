...
#define SELECT_RES(...) _XMM_SELECT_RES_I(_XMM_UNIQUE_LABEL(__xmm_sel_reset), _XMM_SELECT_RES_FILTER_DEFAULT(__VA_ARGS__), _XMM_SELECT_RES_FILTER_RES(__VA_ARGS__))
